...
5. Copy and Paste this repository URL [(https://github.com/DCS-training/Linear-Regression)](https://github.com/DCS-training/Linear-Regression) as the Repository URL (The Project directory name will filled in automatically but you can change it if you want your folder in Notable to have a different name).
